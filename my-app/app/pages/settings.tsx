      ...
      if (user) {
        try {
          ...
          if (userDoc.exists()) {
            ...
            setSubscriptionPlan(data?.plan ?? data?.subscriptionPlan ?? 'Basic')
          } else {
          ...
          <div className='container'>
            ...
            {currentUser ? (
                ...
                {isSettingsLoading ? (
                  <>
                    <div className='setting__content'>
                      <div className='settings__sub--title skeleton skeleton-line skeleton-w-50' />
                      <div
                        className='settings__text skeleton skeleton-line skeleton-w-40'
                        style={{ marginTop: 8 }}
                      />
                    </div>
                    <div className='setting__content'>
                      <div className='settings__sub--title skeleton skeleton-line skeleton-w-30' />
                      <div
                        className='settings__text skeleton skeleton-line skeleton-w-60'
                        style={{ marginTop: 8 }}
                      />
                    </div>
                    <div className='setting__content'>
                      <div
                        className='skeleton skeleton-line skeleton-w-40'
              ...
              <div className='settings__login--wrapper'>
                <img src={loginImg.src} alt='login' />
