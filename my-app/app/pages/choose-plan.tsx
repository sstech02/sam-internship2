...
import { startStripeCheckout } from '../account/stripePayment'
...
function choose_plan() {
   ...
   const upgradeToPremium = async () => {
    const yearlyPriceId = 'price_1TRy0e6C1sJSHzne4itzMoBv'
    const monthlyPriceId = 'price_1TRy086C1sJSHznesYXkJwP1'
    const selectedPriceId = selectedPlan === 'yearly' ? yearlyPriceId : monthlyPriceId

    try {
      setIsCheckingOut(true)
      await startStripeCheckout(selectedPriceId)
    } catch (error) {
  ...
  <div className="plan__header">
    ...
    <figure className="plan__img--mask">
      <img alt="pricing" src={pricing.src} width="860" height="722" decoding="async" data-nimg="1" loading="lazy" style={{ 'color': 'transparent' }} />
    </figure>
  </div>
</div>
        <div className="row">
          ...
          <div className="plan__card--cta">
            <span className="btn--wrapper">
              <button className="btn" style={{ width: "300px" }} onClick={upgradeToPremium} disabled={isCheckingOut}>
                <span>
                  {isCheckingOut
          ...
          <div className="faq__wrapper">
            {faqs.map((faq, index) => (
              <div className="accordion__card" key={faq.question}>
                ...
                <div className={openFaq === index ? "collapse show" : "collapse"}>
