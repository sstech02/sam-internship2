...
async function createDurationMap (
  books: Book[]
    ...
    return (
      <div className='for-you__recommended--books'>
        {Array.from({ length: skeletonCount }).map((_, index) => (
          ...
          >
            <figure className='book__image--wrapper skeleton skeleton-image-180' />
            <div className='recommended__book--title skeleton skeleton-line skeleton-w-90' />
            <div className='recommended__book--author skeleton skeleton-line skeleton-w-70' />
            <div className='recommended__book--sub-title skeleton skeleton-line skeleton-w-100' />
            <div className='recommended__book--details-wrapper'>
              <div className='recommended__book--details'>
                <div className='recommended__book--details-icon skeleton skeleton-circle-16' />
                <div className='recommended__book--details-text skeleton skeleton-line skeleton-w-40' />
              </div>
              <div className='recommended__book--details'>
                <div className='recommended__book--details-icon skeleton skeleton-circle-16' />
                <div className='recommended__book--details-text skeleton skeleton-line skeleton-w-20' />
              </div>
            </div>
          </div>
        ))}
  ...
  useEffect(() => {
    async function loadData () {
      try {
        ...
        const secondsMap = await createDurationMap([
          ...selected,
          ...recommended,
          ...suggested
        ])
        ...
        setSections({
          selected: withFormattedDuration(
            selected,
            secondsMap,
            formatSelectedDuration
          ),
          recommended: withFormattedDuration(
            recommended,
            secondsMap,
            formatClock
          ),
        ...
        <div className='row'>
          <div className='container'>
            <div className='for-you__wrapper'>
              ...
              {isLoading ? (
                <div className='selected__book selected__book--skeleton'>
                  <div className='selected__book--sub-title skeleton skeleton-line skeleton-w-40' />
                  <div className='selected__book--line' />
                  <div className='selected__book--content'>
                    <figure className='book__image--wrapper skeleton skeleton-image-140' />
                    <div className='selected__book--text'>
                      <div className='selected__book--title skeleton skeleton-line skeleton-w-80' />
                      <div className='selected__book--author skeleton skeleton-line skeleton-w-60' />
                      <div className='selected__book--duration-wrapper'>
                        <div className='selected__book--icon skeleton skeleton-circle-40' />
