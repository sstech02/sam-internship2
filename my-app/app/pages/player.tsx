...
import { upsertLibraryBook } from '../data/libraryStore'
...
function Player () {
  ...
  }, [bookData?.audioLink, id, bookData])
          ...
          >
            ...
            {currentUser ? (
              ...
              >
                <img
                  alt='login'
                  src='https://cdn.jsdelivr.net/gh/tabler/tabler-icons/icons/outline/login.svg'
